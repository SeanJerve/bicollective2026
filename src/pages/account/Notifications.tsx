          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {recentNotifications.map((notif) => (
                ...
                >
                  <div
                    className={`w-12 h-12 flex items-center justify-center flex-shrink-0 border-2 border-foreground ${notif.read_at ? "bg-muted" : "bg-primary text-primary-foreground shadow-brutal-sm"}`}
                  >
                    {getIcon(notif.type)}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      {!notif.read_at && (
                        <span className="px-2 py-0.5 bg-destructive text-destructive-foreground text-[10px] font-bold uppercase border border-foreground shadow-brutal-xs">
                          New
                        </span>
                      )}
                    </div>
            ...
            <div className="text-center py-20 border-2 border-dashed border-muted-foreground/30">
              ...
              <h2 className="font-heading text-2xl uppercase text-muted-foreground">
