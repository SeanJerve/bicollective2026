      ...
      <section className="py-8 md:py-16">
        <div className="section-container">
          ...
          <div className="text-center mb-8">
            <h1 className="font-heading text-3xl md:text-5xl uppercase mb-3">
              Welcome Back
            </h1>
          ...
          {/* Side-by-side layout */}
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 max-w-4xl mx-auto items-start">
            {/* Left: Test Accounts Box */}
            ...
            <div className="hidden lg:flex flex-col items-center self-stretch">
              ...
              <span className="text-xs text-muted-foreground py-2 px-1 bg-background">or</span>
              <div className="flex-1 w-px bg-border-subtle" />
            </div>
